...
\begin{figure}[H]
    \centering
    \includegraphics[width = 5 cm]{Latex-imágenes//Imagen7.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width = 8 cm]{Latex-imágenes//diagramaz.png}
...
Se realizaron 5 pruebas al programa para validar su funcionamiento, a continuación veremos los siguientes resultados 
   ...
   \begin{figure}[H]
    \centering
    \includegraphics[width = 7 cm]{Latex-imágenes/tabla de prueba.png}
