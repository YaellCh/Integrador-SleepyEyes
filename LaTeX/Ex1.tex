...
\begin{figure}[H]
    \centering
    \includegraphics[width = 6 cm]{./Latex-imágenes/GraficaEcuacion.png}
...
Se propone una solución al problema de determinar la ecuación de la recta y el ángulo interno formado entre dicha recta y el eje horizontal a partir de las coordenadas de dos puntos dados. La solución utiliza fórmulas matemáticas y funciones trigonométricas para calcular la pendiente de la recta, su intersección en el eje Y, y el ángulo interno. El código proporcionado es modular y permite obtener resultados precisos y eficientes.
