...
\subsection\textbf{Definición de la solución}
...
\subsection\textbf{Ecuación de la recta}
...
\end{tabular}
\\
\\para las pruebas de decimal a binario

\section\textbf{Conclusión}
Se desarrollo una solución para el problema de la conversión de números decimales a su representación binaria. En la implementación se utilizo de bucles y operaciones matemáticas para llevar a cabo la división sucesiva por 2, identificar los residuos y construir la representación binaria del número. El resultado se expresa con claridad y  siendo capaz de manejar tanto números positivos como negativos. Además, se han abordado casos especiales, como el número cero, asegurando la precisión de los resultados. 